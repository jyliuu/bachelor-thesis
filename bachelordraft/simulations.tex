...
By examining \Cref{fig:losses_esl_lw}, we see that the locally weighted ensemble super learner has in fact a slightly higher loss than the ensemble super learner.
\begin{figure}[H]
    \centering
