...
\begin{figure}[H]
    ...
    \caption{XGBoost becoming better at approximating the regression as the sample size increases. Here the predictions of XGBoost is visualized for a training sample size of $ 10,000 $. They appear to be more stable in comparison to \Cref{fig:predictpar}.}
