...
\begin{proof}
    ...
    \end{align*}
    As the inequality holds for all $ \delta > 0 $, we can choose $ \delta $ to depend on $ n $ or just set it to 0. The problem now lies in determining how fast the oracle risk converges, see that by setting $ \delta = 0 $ the inequality becomes 
    \begin{align*}
