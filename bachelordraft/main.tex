...
\begin{align*}
    \min_{a_n \in \mathcal{A}_n } \norm{a - a_n} \leq \frac{1}{n}.
\end{align*}
This is possible since $ \mathcal{A} $ is compact. It thus follows that we can find a sequence of points $ a_n \in \mathcal{A}_n $ such that $ \meta_{a_n} \to \meta_{a} $ for any $ a \in \mathcal{A}$.  
