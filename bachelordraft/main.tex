...
The following plots show the predictions of the locally weighted ensemble, where the raw predictions are shown on the left panel, and the predictions grouped by the most-weighted learner is on the right. 
\begin{figure}[H]
    \centering
